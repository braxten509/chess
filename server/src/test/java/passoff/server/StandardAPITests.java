...
public class StandardAPITests {
  ...
  public void loginWrongPassword() {
    TestUser loginRequest = new TestUser(
      existingUser.getUsername(),
      newUser.getPassword()
    );
  ...
  public void failRegister() {
    ...
    TestUser registerRequest = new TestUser(
      newUser.getUsername(),
      null,
      newUser.getEmail()
    );
  ...
  public void goodJoin() {
    ...
    //join as white
    TestJoinRequest joinRequest = new TestJoinRequest(
    ...
    Assertions.assertNull(
      listResult.getGames()[0].getBlackUsername(),
  ...
  public void badAuthJoin() {
    ...
    TestResult joinResult = serverFacade.joinPlayer(
      joinRequest,
      existingAuth + "bad stuff"
    );
    ...
    for (String color : new String[] { null, "", "GREEN" }) {
      assertHttpBadRequest(
        serverFacade.joinPlayer(
          new TestJoinRequest(color, gameID),
          existingAuth
        )
      );
    }
  ...
  public void gamesList() {
    ...
    TestCreateResult game1 = serverFacade.createGame(
      new TestCreateRequest(game1Name),
      authA.getAuthToken()
    );
    serverFacade.joinPlayer(
    ...
    expectedList[0] = new TestListEntry(
      game1.getGameID(),
      game1Name,
      null,
      authA.getUsername()
    ...
    TestCreateResult game2 = serverFacade.createGame(
      new TestCreateRequest(game2Name),
      authB.getAuthToken()
    );
    serverFacade.joinPlayer(
    ...
    expectedList[1] = new TestListEntry(
      game2.getGameID(),
      game2Name,
      authB.getUsername(),
      null
    ...
    TestCreateResult game3 = serverFacade.createGame(
      new TestCreateRequest(game3Name),
      authC.getAuthToken()
    );
    serverFacade.joinPlayer(
    ...
    TestCreateResult game4 = serverFacade.createGame(
      new TestCreateRequest(game4Name),
      authC.getAuthToken()
    );
    serverFacade.joinPlayer(
    ...
    Comparator<TestListEntry> gameIdComparator = Comparator.comparingInt(
      TestListEntry::getGameID
    );
  ...
  public void clearData() {
    ...
    serverFacade.createGame(
      new TestCreateRequest("Mediocre game"),
      existingAuth
    );
    serverFacade.createGame(
      new TestCreateRequest("Awesome game"),
      existingAuth
    );
