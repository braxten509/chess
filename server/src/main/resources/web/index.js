...
function send(path, params, method) {
  ...
  fetch(path, {
    ...
    .then((data) => {
      ...
      const response =
        data === "" ? "Empty response body" : JSON.stringify(data, null, 2);
