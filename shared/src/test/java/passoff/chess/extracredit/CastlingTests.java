...
public class CastlingTests {
  ...
  private static final String INVALID_CASTLE_PRESENT =
    "ChessGame validMoves contained an invalid castling move";
  private static final String VALID_CASTLE_MISSING =
    "ChessGame validMoves did not contain valid castle move";
  private static final String INCORRECT_BOARD =
  ...
  public void castleWhite() {
    ...
    ChessMove queenSide = new ChessMove(
      kingPosition,
      new ChessPosition(1, 3),
      null
    );
    ChessMove kingSide = new ChessMove(
      kingPosition,
    ...
    Assertions.assertTrue(
      game.validMoves(kingPosition).contains(queenSide),
      VALID_CASTLE_MISSING
    );
    Assertions.assertTrue(
      game.validMoves(kingPosition).contains(kingSide),
      VALID_CASTLE_MISSING
    );
  ...
  public void noCastleAfterMove() throws InvalidMoveException {
    ...
    //move left rook
    game.makeMove(
      new ChessMove(new ChessPosition(1, 1), new ChessPosition(1, 4), null)
    );
    game.makeMove(
      new ChessMove(new ChessPosition(8, 3), new ChessPosition(8, 2), null)
    );

    //move rook back to starting spot
    game.makeMove(
      new ChessMove(new ChessPosition(1, 4), new ChessPosition(1, 1), null)
    );
    /*
                | |k| | | | | | |
		        | | | | | | | | |
    ...
    //move king
    game.makeMove(
      new ChessMove(new ChessPosition(8, 2), new ChessPosition(8, 3), null)
    );
    ...
    game.makeMove(
      new ChessMove(new ChessPosition(8, 3), new ChessPosition(8, 4), null)
    );
