...
public class ChessMoveTests {
  ...
  public void setUp() {
    ...
    startDifferent = new ChessMove(
      new ChessPosition(2, 4),
      new ChessPosition(1, 5),
      null
    );
    endDifferent = new ChessMove(
      new ChessPosition(2, 6),
      new ChessPosition(5, 3),
      null
    );
    promoteDifferent = new ChessMove(
      new ChessPosition(2, 6),
      new ChessPosition(1, 5),
  ...
  public void equalsTest() {
    Assertions.assertEquals(
      original,
      equal,
      "equals returned false for equal moves"
    );
    Assertions.assertNotEquals(
      original,
      startDifferent,
      "equals returned true for different moves"
    );
    Assertions.assertNotEquals(
      original,
      endDifferent,
