...
public class MakeMoveTests {
  ...
  public void invalidMakeMoveTooFar() {
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(2, 1), new ChessPosition(5, 1), null)
      )
    );
  }
  ...
  public void invalidMakeMovePawnDiagonalNoCapture() {
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(2, 1), new ChessPosition(3, 2), null)
      )
    );
  }
  ...
  public void invalidMakeMoveThroughPiece() {
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(1, 1), new ChessPosition(4, 1), null)
      )
    );
  }
  ...
  public void invalidMakeMoveNoPiece() {
    ...
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(4, 4), new ChessPosition(4, 5), null)
      )
    );
  }
  ...
  public void invalidMakeMoveInvalidMove() {
    ...
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(8, 7), new ChessPosition(5, 5), null)
      )
    );
  }
  ...
  public void invalidMakeMoveTakeOwnPiece() {
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(1, 3), new ChessPosition(2, 4), null)
      )
    );
  }
  ...
  public void invalidMakeMoveCapturedPiece() throws InvalidMoveException {
    ...
    game.makeMove(
      new ChessMove(new ChessPosition(3, 6), new ChessPosition(5, 5), null)
    );
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(5, 5), new ChessPosition(4, 5), null)
      )
    );
  }
  ...
  public void invalidMakeMoveJumpEnemy() {
    ...
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(5, 1), new ChessPosition(5, 5), null)
      )
    );
  }
  ...
  public void invalidMakeMoveInCheck() {
    ...
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(1, 7), new ChessPosition(1, 8), null)
      )
    );
  }
  ...
  public void invalidMakeMoveDoubleMoveMovedPawn() {
    ...
    Assertions.assertThrows(InvalidMoveException.class, () ->
      game.makeMove(
        new ChessMove(new ChessPosition(3, 7), new ChessPosition(5, 7), null)
      )
    );
  }
  ...
  public void promotionMoves(ChessPiece.PieceType promotionType)
    ...
    //White promotion
    ChessMove whitePromotion = new ChessMove(
    ...
    ChessPiece whiteEndPiece = game
      .getBoard()
      .getPiece(whitePromotion.getEndPosition());
    ...
    game.setTeamTurn(ChessGame.TeamColor.BLACK);
    ChessMove blackPromotion = new ChessMove(
    ...
    ChessPiece blackEndPiece = game
      .getBoard()
      .getPiece(blackPromotion.getEndPosition());
