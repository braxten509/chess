...
public class ValidMovesTests {
  ...
  private static final String TRAPPED_PIECE_MOVES =
  ...
  public void forcedMove() {
    ...
    var validMoves = TestUtilities.loadMoves(
      knightPosition,
      new int[][] { { 3, 5 }, { 6, 2 } }
    );
    ...
    validMoves = TestUtilities.loadMoves(
      queenPosition,
      new int[][] { { 3, 5 }, { 4, 4 } }
    );
