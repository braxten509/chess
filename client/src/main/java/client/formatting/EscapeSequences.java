...
/**
 * This class contains constants and functions relating to ANSI Escape
 * Sequences that are useful in the Client display.
 */
public class EscapeSequences {
  ...
  public static final String RESET_ALL = RESET_BG_COLOR + RESET_TEXT_COLOR + RESET_TEXT_BLINKING
          + RESET_TEXT_UNDERLINE + RESET_TEXT_ITALIC + RESET_TEXT_BOLD_FAINT;
