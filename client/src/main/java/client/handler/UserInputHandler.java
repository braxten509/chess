...
public class UserInputHandler {
  ...
  private boolean validNumberOfParameters(int expectedParameters, String userInput) {
  ...
  private void printCommandError(String command) {
    printf("\nImproper syntax. Expected: ", SpacingType.NONE, SET_TEXT_COLOR_YELLOW);
    ...
    switch (command.toLowerCase()) {
      ...
      case "join" ->
          printf("join <gameNumber> <BLACK|WHITE>", SpacingType.NONE, SET_TEXT_COLOR_YELLOW);
  ...
  private boolean expectedParameters(int expectedNumberOfParams, String regex, String userInput) {
  ...
  private void loggedOutCommands(String command) {
    ...
    switch (command.toLowerCase()) {
      ...
      default -> {
        if (!command.matches("\\bquit\\b\\s*\\S+") && !command.matches("\\bexit\\b\\s*\\S+")) {
          printf(
